...
<div data-barba="container" data-barba-namespace="home">
  <div class="wrapper">
    ...
    <div class="contents-wide">
      <div class="page-aboutContents">
        <div class="page-aboutContentsProfile">
          ...
          <p class="page-aboutContents_text">那須で生まれて 子どもの頃から馴染みの風景は、いつもどの季節も心震えることがあります。<br>
          美しいという中に潜む寂しさや、私の中にある茶化しのような気持ち、五感のすべてで感じたことを一緒くたにして、絵や版画へと表現を試みています。</p>
        </div>
        <div class="page-aboutContentsHistory">
          <ul class="page-aboutContentsHistory_list">
            <li>玉屋画層  ［銀座］</li>
            <li>wiener Mal Schule展  ［グループ展］</li>
            <li>ギャラリー筍心学  ［大田原］</li>
            <li>みちのくギャラリー  ［那須］</li>
            <li>ギャラリー三匹の猫  ［那須］</li>
            <li>覚楽  ［那須塩原市］</li>
            <li>J.Marunouchiギャラリー  ［NY, USA］</li>
            <li>馬頭広重美術館  ［那珂川町］</li>
            <li>ギャラリー懐風  ［真岡市］</li>
            <li>福田屋百貨店  ［宇都宮市］</li>
            <li>東武百貨店  ［宇都宮市］</li>
            ...
            <li>遊クラフト  ［那須］</li>
            <li>殻々工房  ［那須］</li>
            <li>ギャラリーHANNA  ［宇都宮市］</li>
            <li>ギャラリーもみの木  ［足利市］</li>
            <li>BBAM Gallerly  ［Montreal, CANADA］</li>
            <li>カナダ日本大使館  ［Ottawa, CANADA］ミシシッピ・バレー・</li>
            <li>テキスタイル博物館  ［Almonte］</li>
            <li>CON展  ［足利市］</li>
            <li>那須高原作家協会展</li>
            <li>ギャラリー CN  ［藤沢市］</li>
            <li>ギャラリー Ato  ［真鶴市］</li>
            <li>瀧澤家住宅  ［さくら市］</li>
            <li>ギャラリー忘我亭  ［長野県蓼科］</li>
          </ul>
        </div>
        <button class="js-about-video-trigger">再生</button>
      </div>
    </div>
    ...
    <video src="<?php echo get_template_directory_uri(); ?>/assets/videos/about.mp4" playsinline muted loop class="page-about-video js-about-video"></video>
  </div>
</div>
